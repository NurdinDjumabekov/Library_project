...
import { sendRequestAllDataUser, sendRequestDataEveryUser } from "../../store/reducers/usersStateSlice";
...
const UsersPage = () => {
  ...
  const { preloader, dataFavotitesBook, finishedBookUser, readingNowBookUser, checkedUser, choiceUserBook } =
              ...
              <div className={styles.parent_userBlock}>
                <div className={styles.child_books_userBlock}>
                  ...
                  {choiceUserBook === "read_bookmark" ? (
                    <FavoritesBookUsers dataFavotitesBook={readingNowBookUser} />
                  ) : (
                    null
                  )}
