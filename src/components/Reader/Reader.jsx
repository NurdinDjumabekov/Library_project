...
const Reader = ({data}) => {
  ...
  const currentPageState = useSelector((state) => state.sendRequestEveryBookSlice.readerCurrentPage)
  ...
  return (
    <div className={styles.readerComponent}>
      ...
      <div className={styles.reader}>
        <Document file={pdf} onLoadSuccess={onDocumentLoadSuccess} className={styles.documentPDF}>
          <Page pageNumber={currentPageState} className={styles.pagePDF} renderMode="canvas" canvasBackground="transparent" renderAnnotationLayer={false} width={1200} scale={0.815}/>
        </Document>
      </div>
